                                       ...
                                       <a class="btn btn-icon-only green" href="<?php echo site_url($this->project.'/salaryView/' . $getAllsalaryByDateListView[0]->date.'/'.$getAllsalaryByDateListView[0]->month.'/'.$getAllsalaryByDateListView[0]->year ); ?>">
                                        ...
                                        $graunatTotal = 0;
                                            ...
                                            <tr>
                                                ...
                                                <td ><?php echo $value->basicSalary; ?></td>
                                                <td ><?php echo $value->houseRant; ?></td>
                                                <td ><?php echo $value->conveyanceAllowance; ?></td>
                                                <td ><?php echo $value->medicalAllowance; ?></td>
                                                <td ><?php echo $value->others; ?></td>
                                                <td ><?php echo $value->grossSalary; ?></td>
                                                <td ><?php echo $value->arrearSalary; ?></td>
                                                <td ><?php echo $value->wPFDeduction; ?></td>
                                                <td ><?php echo $value->absentDeduction; ?></td>
                                                <td ><?php echo $value->loanDeduction; ?></td>
                                                <td ><?php echo $value->aITDeduction; ?></td>
                                                <td ><?php echo $value->netPayAmount; ?></td>
                                                 <td ></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><?php  echo number_format($graunatTotalbasicSalary, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalhouseRant, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalconveyanceAllowance, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalmedicalAllowance, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalothers, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalgrossSalary, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalarrearSalary, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalwPFDeduction, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalabsentDeduction, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalloanDeduction, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalaITDeduction, 2);?></td>
                                                <td><?php  echo number_format($graunatTotalnetPayAmount, 2);?></td>
                                                <td></td>
                                            </tr>
