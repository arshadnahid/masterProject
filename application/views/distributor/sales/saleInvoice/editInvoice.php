    ...
    <form id="publicForm" action="" method="post" class="form-horizontal">
        ...
        <div class="col-md-2" style="margin-top: 10px;">
            ...
            <table class="table table-bordered table-striped table-condensed flip-content">
                ...
                <tr>
                    <td class="text-right" style="width: 30%"><strong><?php echo get_phrase('Previous_Due')?>:</strong></td>
...
<!--            <table class="table table-fixed " id="CylinderDueTable">
                <thead>
                <tr>
                    <th class="col-md-2" style="margin-left: -8px;"><strong><?php echo get_phrase('Sl')?></strong></th>
                    <th class="col-md-8"><strong><?php echo get_phrase('Product')?></strong></th>
        ...
        <div class="col-md-9" style="margin-top: 10px;">
            ...
            <table class="table table-bordered table-hover tableAddItem" id="show_item">
                <thead>
                <tr>
                    <th nowrap style="width:23%; border-radius:10px; text-align:center"><strong><?php echo get_phrase('Category')?> <span style="color:red;"> *</span></strong></th>
                    ...
                    <th style="width:10%; white-space:nowrap; width:100px; vertical-align:top;"><strong><?php echo get_phrase('Quantity')?> <span style="color:red;"> *</span></strong></th>
<!--                    <th nowrap><strong><?php /*echo get_phrase('Receivable_Qty')*/?></strong></th>-->
                    <th nowrap style="text-align:center"><strong><?php echo get_phrase('Unit_Price_Bdt')?> <span style="color:red;"> *</span></strong></th>
                    <th nowrap style="text-align:center"><strong><?php echo get_phrase('Total_Price_Bdt')?> <span style="color:red;"> *</span></strong></th>
<!--                    <th nowrap style="width:17%;border-radius:10px;"><strong><?php  /*echo get_phrase('Returned Cylinder')*/?> <span style="color:red;"> </span></th>
                ...
                <div class="portlet-body" style="padding:1px">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="text" id="total_price" value="<?php echo $totalEditPrice . '.00'; ?>" class="form-control total_price text-right" readonly="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="paymentTr">
                        ...
                        <div class="col-md-7">
                            <input type="text" id="payment" onkeyup="calculatePartialPayment()" style="text-align: right"
                                   autocomplete="off"
                                   name="partialPayment"<?php echo $editInvoice->paid_amount; ?> value="<?php echo $editInvoice->paid_amount; ?>" class="form-control" autocomplete="off" placeholder="0.00"
                                   oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
    ...
    var calculateCustomerDue = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                due=due-parseFloat($('#currentDue').val())
