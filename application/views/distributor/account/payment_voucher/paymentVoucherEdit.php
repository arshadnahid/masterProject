                    ...
                    <form id="publicForm" action="" method="post" class="form-horizontal">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Payee <span
                                            style="color:red;">*</span></label>

                                <div class="col-sm-6">

                                    <select name="payType" onchange="selectPayType(this.value)"
                                            class="chosen-select form-control" id="payType"
                                        ...
                                        if (empty($editVoucher->customer_id) and empty($editVoucher->supplier_id)) {
                                        ...
                                        if (!empty($editVoucher->customer_id)) {
                                        ...
                                        if (!empty($editVoucher->supplier_id)) {
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="oldValue">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Payee To
