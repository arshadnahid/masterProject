    ...
    <form id="publicForm" action="" method="post" class="form-horizontal">
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group" id="showAccount">
                <label class="col-sm-3 control-label text-right" for="form-field-1"><span style="color:red;"> *</span>
                <?php echo  get_phrase('Add Account')?>
                </label>
                <div class="col-sm-7">
        ...
        <div class="col-md-10" style="margin-top:10px">
            ...
            <table class="table table-bordered table-hover" id="show_item">
                ...
                <tr>
                    ...
                    <th nowrap style="width:12%;border-radius:10px;" id="product_th"><strong><?php echo get_phrase('Category')?><span
                    ...
                    <th nowrap><strong><?php echo  get_phrase('Unit Price')?>(BDT) <span
                                    style="color:red;"> *</span></strong></th>
                    <th nowrap><strong><?php echo  get_phrase('Total Price')?>(BDT) <span
                                    style="color:red;"> *</span></strong></th>
