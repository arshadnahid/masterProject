    ...
    <form id="publicForm" action=""  method="post" class="form-horizontal">
        <div class="col-sm-12 col-md-4" style="margin-top: 10px;">
            <div class="form-group">
                <label class="col-sm-3 control-label formfonterp" for="form-field-1"> <span style="color:red;">*</span><strong>Sales Date</strong></label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label text-right formfonterp" for="form-field-1"><strong> Invoice No.</strong></label>
                <div class="col-sm-7">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label formfonterp" for="form-field-1"><strong> Transportation</strong></label>
                <div class="col-sm-7">
        ...
        <div class="col-md-4" style="margin-top: 10px;">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label formfonterp" for="form-field-1" style="white-space: nowrap;"><strong>Delivery Address</strong></label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label formfonterp" for="form-field-1" style="white-space: nowrap;"><strong>Delivery Date</strong></label>
                <div class="col-sm-7">
            ...
            <div class="clearfix"></div>
            <div class="form-group">
                <label class="col-sm-3 control-label formfonterp" style="white-space: nowrap;" for="form-field-1"><span style="color:red;">*</span><strong>Payment Type</strong></label>
                <div class="col-sm-7">
            ...
            <div class="clearfix"></div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right formfonterp" for="form-field-1"><span style="color:red;"> *</span><strong>Account</strong></label>
                <div class="col-sm-7">
            ...
            <table class="table table-fixed ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-xs-6">Holly Galivan</td>
                        <td class="col-xs-4">44</td>
                    </tr>
                    <tr>
                        <td class="col-xs-2">3</td>
                        <td class="col-xs-6">Mary Shea</td>
                        <td class="col-xs-4">86</td>
                    </tr>
                    <tr>
                        <td class="col-xs-2">4</td>
                        <td class="col-xs-6">Jim Adams</td>
                        <td class="col-xs-4">23</td>
                    </tr>
                    <tr>
                        <td class="col-xs-2">5</td>
                        <td class="col-xs-6">Henry Galivan</td>
                        <td class="col-xs-4">44</td>
                    </tr>
                    <tr>
                        <td class="col-xs-2">5</td>
                                    ...
                                    <th nowrap style="width:10%;border-radius:10px;"><strong>Returned Qty <span style="color:red;"></th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td id="product_td">
                                                            <select  id="productID" onchange="getProductPrice(this.value)" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Select  Product">
                                                                <option value=""></option>
                                                        ...
                                                        <td>
                                                            <select  id="productID2"  class="chosen-select form-control" id="form-field-select-3" data-placeholder="Select  product ">
                                                                <option value=""></option>
                                                                <?php
                                                ...
                                                <div class="col-md-2" style="margin-top: 10px;">
                                                    <div class="portlet box blue">
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap;;font-size:12px"><strong>Total</strong></label>
                                                                <div class="col-md-6">
                                                                    <strong class="total_price"></strong>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap;;font-size:12px"><strong>Discount (-)</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px"><strong>Grand Total</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px"><strong>VAT (%) ( + )</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px"><strong>Loader ( + )</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Transportation( + )</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Net Total</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Chaque Amount</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Payment( - )</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group" style="display:none;">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Due Date</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Due Amount</strong></label>
                                                                <div class="col-md-6">
                                                                    <input type="text" id="payment" onkeyup="calculatePartialPayment()" style="text-align: right" name="partialPayment" value=""  class="form-control" autocomplete="off"  placeholder="0.00"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Previous Due</strong></label>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-6 control-label" style="white-space: nowrap; font-size:12px;"><strong>Total Due</strong></label>
                                                                <div class="col-md-6">
