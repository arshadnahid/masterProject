                        ...
                        <form id="publicForm" action=""  method="post" class="form-horizontal">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="oldValue">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="form-field-1"> <span style="color:red;">*</span>ID </label>
                                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label no-padding-right" for="form-field-1"> Product </label>
                                            <div class="col-md-8">
