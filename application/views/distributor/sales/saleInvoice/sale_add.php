        ...
        <div class="col-sm-12 col-md-4" style="margin-top: 10px;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <table class="table table-bordered" id="CylinderDueTable">
                        <!--<table class="table table-fixed " id="CylinderDueTable">-->
                        <thead>
                        <tr>
                            <th class="col-md-3" style="margin-right: -8px;">
                                <strong><?php echo get_phrase('SL') ?></strong>
                            </th>
                            <th class="col-md-7 text-center"><strong><?php echo get_phrase('Product') ?></strong></th>
                            <th class="col-md-2" style="margin-left: 8px;">
                                <strong><?php echo get_phrase('Qty') ?></strong></th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-md-10" style="margin-top: 10px;">
            ...
            <table class="table table-bordered table-hover tableAddItem" id="show_item">
                ...
                <tr>
                    ...
                    <td>
                        <select id="productID2" class="chosen-select form-control received_cylilder_id"  onchange="received_cylilder_price(this.value)"
                                data-placeholder="Select  product ">
                            <option value=""></option>
                            <?php
        ...
        if (productCatID == 2 && ispackage == 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    if(data<=0){
                        swal("There is no price or package for Against This Refill Product !", "Please Set a Price or Package !", "error");
                        $('#productID').val('').trigger('chosen:updated');
                        $('.quantity ').val('');
                        return false;
                    }
