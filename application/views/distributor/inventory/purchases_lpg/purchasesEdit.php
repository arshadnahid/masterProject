        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group">
                <label class="col-sm-3 control-label text-right"
                       for="form-field-1"><span style="color:red;"> *</span> <?php echo get_phrase('Purchases Date') ?>
                </label>
                <div class="col-sm-7">
                    ...
                    <div class="input-group">
                        <select id="supplierid" name="supplierID"
                            ...
                            <?php foreach ($supplierList as $key => $each_info): ?>
                                <option <?php
                                if ($purchasesList->supplier_id == $each_info->sup_id) {
                                    echo "selected";
                                }
            ...
            <div class="form-group" id="showAccount" style="<?php echo $style ?>">
                <label class="col-sm-3 control-label text-right" for="form-field-1"><span
                            style="color:red;"> *</span><?php echo get_phrase('Add Account') ?></label>
                <div class="col-sm-7">
        ...
        <div class="col-md-12" id="showBankInfo" style="margin-top: 3px;<?php echo $style ?>">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label class="col-sm-4  formfonterp"
                           style="white-space: nowrap;padding-top: 7px;"><strong><?php echo get_phrase('Branch Name') ?></strong></label>
                    <div class="col-sm-8">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="<?php echo $purchasesList->check_no; ?>" class="form-control"
            ...
            <table class="table table-bordered table-hover" id="show_item">
                ...
                <tr>
                    ...
                    <th nowrap style="width:17%;border-radius:10px;">
                        <strong><?php echo get_phrase('Returned Cylinder'); ?> </strong><span style="color:red;"></span>
                    </th>
                    <th nowrap style="width:10%;border-radius:10px;">
                        <strong><?php echo get_phrase('Returned Qty') ?></strong>
                ...
                <tr>
                    ...
                    <td><input type="hidden"
                               ...
                               value="0"><input type="text"
                                                ...
                                                placeholder="0"></td>
                    <td><input type="text"
                               class="form-control text-right returnAble decimal" onclick="this.select();"
                               autocomplete="off"
                               placeholder="0"></td>
                    <td><input type="text"
                               ...
                               placeholder="0.00"></td>
                    <td><input type="text"
                               class="form-control text-right price decimal" onclick="this.select();" autocomplete="off"
                    ...
                    <td><input type="text"
                               class="form-control text-right returnQuentity decimal" onclick="this.select();"
                               autocomplete="off"
                               placeholder="0.00"></td>
                ...
                foreach ($stockListEdit[$purchasesList->purchase_invoice_id] as $key => $eachStock) {
                    ...
                    $package_id_delete='';
                    $is_package=$eachStock['is_package'];
                    $rowspan='';
                    $style='';
                    if($is_package==1){
                        //$rowspan = '2';
                    ...
                    <tr class="new_item<?php echo $key + 100; ?>   packageDeleteRow_<?php echo $eachStock['package_id']; ?>">
                        <td style="padding-left:15px;" colspan="2">
                            ...
                            <input type="hidden" name="purchase_details_id[]"
                                   value="<?php echo $eachStock['purchase_details_id']; ?>"/>
                            <input type="hidden" name="is_package_<?php echo $eachStock['purchase_details_id']; ?>"
                                   value="<?php echo $eachStock['is_package']; ?>"/>
                            <?php

                            echo ' [ ' . $eachStock['title'] . ' ] ' . $eachStock['productName'] . ' [ ' . $eachStock['brandName'] . ' ] ';
                            ?>
                            <input type="hidden" name="product_id_<?php echo $eachStock['purchase_details_id']; ?>"
                                   value="<?php echo $eachStock['product_id']; ?>">
                        </td>
                        <td align="right">
                            <input type="text" id="qty_<?php echo $key + 100; ?>" autocomplete="off"
                                   class="add_quantity text-right form-control decimal"
                                   name="quantity_<?php echo $eachStock['purchase_details_id']; ?>"
                                   value="<?php echo $eachStock['quantity']; ?>">
                        </td>
                        <?php if ($eachStock['category_id'] == 2 && $eachStock['is_package'] == 0): ?>
                            <td align="right">
                                <input type="text" autocomplete="off"
                                       class="add_ReturnQuantity text-right form-control decimal"
                                       name="returnAbleQuantity_<?php echo $eachStock['purchase_details_id']; ?>"
                                       value="<?php echo $eachStock['tt_returnable_quantity']; ?>">
                            </td>
                        <?php else: ?>
                            <td align="right">
                                <input type="text" autocomplete="off"
                                       class="add_ReturnQuantity text-right form-control decimal " readonly="readonly"
                                       name="returnAbleQuantity_<?php echo $eachStock['purchase_details_id']; ?>"
                                       value="<?php $eachStock['tt_returnable_quantity']; ?>">
                            </td>
                        <?php endif; ?>
                        <td align="right">
                            <input type="text" id="rate_<?php echo $key + 100; ?>" autocomplete="off"
                                   class="add_rate  text-right form-control decimal"
                                   name="unit_price_<?php echo $eachStock['purchase_details_id']; ?>"
                                   value="<?php echo $eachStock['unit_price']; ?>">
                        </td>
                        <td align="right">
                            <?php
                            $totalEditPrice += ($eachStock['quantity'] * $eachStock['unit_price']);
                            ?>
                            <input type="text" autocomplete="off" class="add_price form-control text-right"
                                   id="tprice_<?php echo $key + 100; ?>" readonly name="price_[]"
                                   value="<?php echo($eachStock['quantity'] * $eachStock['unit_price']); ?>">
                        </td>
                        <td colspan="2">
                            <?php if ($eachStock['category_id'] == 2) { ?>
                                <table class="table table-border"
                                       id="return_product_<?php echo $eachStock['purchase_details_id']; ?>">
                                    <tr>
                                        <?php

                                         if($eachStock['is_package']!=1) {


                                             ?>
                                             <td>
                                                 <select class="chosen-select form-control   Add returnedProduct_<?php echo $eachStock['purchase_details_id'] ?> "
                                                         data-placeholder="Search by product name">
                                                     <option value=""></option>
                                                     <?php
                                                     foreach ($cylinderProduct as $eachProduct):
                                             ...
                                             <td>
                                                 <div class="input-group">
                                                     <input type="text"
                                                            class="form-control returnedProductQty_<?php echo $eachStock['purchase_details_id']; ?>"/>
                                                     <a href="javascript:void(0)"
                                                        id="<?php echo $eachStock['purchase_details_id']; ?>"
                                                        class=" AddreturnedProduct   btn blue   input-group-addon"><i
                                                                 class="fa fa-plus" style=" color:#fff"></i> </a>
                                                 </div>
                                             </td>
                                             <?php
                                         }
                                            ...
                                            foreach ($value1 as $key2 => $value2) {
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="text-right form-control" id=""
                                                               readonly
                                                               name="returnproductEdit_<?php echo $eachStock['purchase_details_id'] ?>[]"
                                                               value="<?php echo $value2['purchase_return_id'] ?>">
                                                        <?php echo $value2['return_product_cat'] . ' ' . $value2['return_product_name'] . ' ' . $value2['return_product_unit'] . '[ ' . $value2['return_product_brand'] . ' ]' ?>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" class="text-right form-control" id=""
                                                                   readonly
                                                                   name="returnQuentityEdit_<?php echo $eachStock['purchase_details_id'] ?>[]"
                        ...
                        if($is_package==1) {
                            $package_id_delete=$eachStock['package_id'];
                        }

                        ?>
                        <td  style="<?php echo $style?>"    rowspan="<?php echo $rowspan?>">
                            <a del_id="<?php echo $key + 100; ?>" <?php echo $eachStock['is_package']==1?'package_id_delete='.$eachStock['package_id']:''?> autocomplete="off"
                               class="delete_item btn form-control btn-danger" href="javascript:void(0);" title=""><i
                ...
                <div class="portlet-body" style="padding:1px">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px"
                               data-toggle="tooltip"
                               title="Transportation (+) :"><strong><?php echo get_phrase('Trans') ?>..( +
                                ):</strong></label>
                        <div class="col-md-7">
...
<script>
    ...
    function getBankBranch(id) {
        $('#branchName').html('');
        var branchId = '<?php echo $purchasesList->bank_branch_id;?>';
...
<script type="text/javascript" src="<?php echo base_url('assets/purchases_lpg/purchasesEdit.js'); ?>"></script>
