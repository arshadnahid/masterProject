...
/*
 *  ==============================================================================
 *  Author  : Mahmud Arshad Nahid
 *  Email   : mr.nahid1992@gmail.com
 *  For     : mPDF
...
class Tec_mpdf
{
    ...
    public function generate($content, $name = 'download.pdf', $output_type = null, $footer = null, $margin_bottom = null, $header = null, $margin_top = null, $orientation = 'P')
    {
        ...
        if (is_array($content)) {
            ...
            $content .= '<style type="text/css">.hideforpdf { display: none; }</style>';
            ...
            $stylesheet = file_get_contents('http://localhost/asadstore16/assets/global/plugins/bootstrap/css/bootstrap.min.css');
