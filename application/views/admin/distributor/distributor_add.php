                    ...
                    <form id="publicForm" action=""  method="post" class="form-horizontal">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="companyName"  value="" class="form-control" placeholder="Name" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Owner Name</label>
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="dist_name"  value="" class="form-control" placeholder="Owner Name" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Contact NO</label>
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="contactNo"  value="" class="form-control" placeholder="Owner Name" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="contactPerson"  value="" class="form-control" placeholder="Contact Person Name" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Contact NO</label>
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="contactPersonCont"  value="" class="form-control" placeholder="Contact Person Contact NO" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" onblur="checkDuplicateEmail(this.value)" name="dist_email"  value="" class="form-control" placeholder="Email" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="dist_phone"  value="" class="form-control" placeholder="Phone" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select  name="zone" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Zone Add">
                                        ...
                                        <?php foreach ($zoneList as $key => $value): ?>
                                            <option value="<?php echo $value->zone_id; ?>"><?php echo $value->zone_title; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <!--<input type="text" id="form-field-1" name="dis_website"  value="" class="form-control" placeholder="Website" />-->
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="form-field-1" name="dist_address"  value="" class="form-control" placeholder="Address"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <script>
