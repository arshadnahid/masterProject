                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <table class="table table-bordered table-hover" id="show_item">
                                                    <thead>
                                                        <tr>
                                                            <td style="width:220px" align="center"><strong>Product<span style="color:red;"> *</span></strong></td>
                                                            <td style="width:250px" align="center"><strong>Quantity<span style="color:red;"> *</span></strong></td>
                                                            <td nowrap align="center"><strong>Returnable Cylinder(Qty)</strong></td>
                                                            <td nowrap align="center"><strong>Unit Price(BDT)<span style="color:red;"> *</span> </strong></td>
                                                            <td nowrap align="center"><strong>Total Price(BDT)</strong></td>
