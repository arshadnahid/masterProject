                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <table class="table table-bordered">
                            ...
                            <!-- Assets -->
                            <tr class="item-row">
                                <td colspan="3"><strong>A. Assets</strong></td>
                            </tr>
                            ...
                            foreach ($assetList as $key => $row_cma):
                                if ($key != 0) {
                                    if ($row_cma['posted'] == 0) {
                                        ...
                                        // Opening Balance
                                        $total_opendebit = $this->Finane_Model->opening_balance_dr($this->dist_id, $row_cma['id'],'',$startDate,$endDate);
                                    $total_opencredit = $this->Finane_Model->opening_balance_cr($this->dist_id, $row_cma['id'],'',$startDate,$endDate);
                                    $total_pvsdebit = 0;
                                    $total_pvscredit = 0;
                                    ...
                                    if (!empty($total_pvsdebit) || !empty($total_pvscredit) || !empty($ddbitValue) || !empty($ddcreditValue) || !empty($cbbbb) || !empty($dbbbb)):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url($this->project.'/generalLedger/' . $row_cma['id']); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo   '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;'.$row_cma['parent_name']; ?></a>
                                            </td>
...
/*                                                if ($debit_balance < $credit_balance): echo number_format((float)$credit_balance - $debit_balance, 2, '.', ',');
                                    ...
                                    if($row_cma['label']==1){
                                        ...
                                        $lebelThree=$lebelThree+1;
                                    }else if($row_cma['label']==4){
                                        $lebelFour=$lebelFour+1;
                                    }
                            ...
                            <!-- Assets -->
                            <tr class="item-row">
                                <td colspan="3"><strong>B. Capital & Liabilities</strong></td>
                            </tr>
                            ...
                            $lebelThree=0;
                            $lebelFour=0;
                            foreach ($liabilityList as $key => $row_cma):
                                if ($key != 0) {
                                    if ($row_cma['posted'] == 0) {
                                        ?>
...
/*                                                if ($debit_balance < $credit_balance): echo number_format((float)$credit_balance - $debit_balance, 2, '.', ',');
                            ...
                            <tr class="item-row">
                                <td colspan="3"><strong>C. Income</strong></td>
                            </tr>
...
/*                                                if ($debit_balance < $credit_balance): echo number_format((float)$credit_balance - $debit_balance, 2, '.', ',');
                            ...
                            ?>
                            <tr class="item-row">
                                <td colspan="3"><strong>D. Expense</strong></td>
                            </tr>
                            ...
                            $lebelThree=0;
                            $lebelFour=0;
                            foreach ($expense as $key => $row_cma):
                                if ($key != 0) {
                                    if ($row_cma['posted'] == 0) {
                                        ?>
