    ...
    $(document).ready(function () {
        ...
        $("#add_item").click(function () {
            ...
            if (productCatID == '') {
                ...
                $("#show_item tbody").append('<tr class="new_item' + productCatID + productID + '"><td style="padding-left:15px;">' + productCatName + '<input type="hidden" name="category_id[]" value="' + productCatID + '"></td><td style="padding-left:15px;">' + productName + '<input type="hidden"  name="product_id[]" value="' + productID + '"></td><td align="right">' +  '<input type="text" id="QTY_'+productID+'" class="add_quantity  form-control text-right decimal" name="quantity[]" value="' + quantity + '" autocomplete="off"></td><td align="right">' +  '<input type="text" id="RATE_'+productID+'" class="add_rate form-control text-right decimal" name="rate[]" value="' + rate + '" autocomplete="off"></td><td align="right">' +  '<input type="text" id="ITEMPRICE_'+productID+'" class="add_price form-control text-right decimal" name="price[]" value="' + price + '" readonly="true"></td><td><a del_id="' + productCatID + productID + '" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;</a></td></tr>');
