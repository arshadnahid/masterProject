                        ...
                        <tbody>
                            ...
                            foreach ($query as $key => $row):
                                ...
                                <tr>
                                    ...
                                    <td align="left"><a href="#"><?php echo $row['trans_type']; ?></a></td>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>                           
                                ...
                                <td align="center"><strong>Purchases</strong></td>
                        ...
                        <tbody>
                            ...
                            if ($supplierId == 'all'):
                                ...
                                foreach ($query as $key => $row):
                                    $openningBal = $this->Finane_Model->supplier_cus_openingAmount(2, $row['client_vendor_id'], $from, $this->dist_id);
                                ...
                                <?php
                                foreach ($query as $key => $row):
                                    $openningBal = $this->minventory->supplier_cus_openingAmount(2, $row['client_vendor_id'], $from, $to);
                                    $balance = $row['debit'] - $row['credit'];
                                    $ttopen += $openningBal;
                                    $ttdrebit += $row['debit'];
                                    $ttcredit += $row['credit'];
