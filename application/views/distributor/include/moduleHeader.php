...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales report
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(7, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    //inventory
                                                    $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(7, $admin_id, $limit, $statr = 6);
                                                    foreach ($sub_menu as $each_menu):
                                                        $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //inventory
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(11, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //inventory
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(11, $admin_id, $limit, $statr = 6);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                            ...
                                            /*                                                            $limit = 6;
                                                                                                        ...
                                                                                                        //inventory
                                                                                                        $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(72, $admin_id, $limit, $statr = 0);
                                                                                                        foreach ($sub_menu as $each_menu):
                                                                                                            $url = $each_menu->url;
                                            ...
                                            /*                                                            $limit = 6;
                                                                                                        ...
                                                                                                        //inventory
                                                                                                        $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(72, $admin_id, $limit, $statr = 6);
                                                                                                        foreach ($sub_menu as $each_menu):
                                                                                                            $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales operation
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(10, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                            ...
                                                            <?php endforeach; ?>
                                                            <li>
                                                                <a href="<?php echo site_url($this->project .'/'.'salesLpgInvoice_add'); ?>">   <?php echo get_phrase('sales Lpg Invoice add'); ?></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <!--<div class="col-md-6">
                                                    ...
                                                    /*                                                            $limit = 5;
                                                                                                                //sales operation
                                                                                                                $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(10, $admin_id, $limit, $statr = 5);
                                                                                                                foreach ($sub_menu as $each_menu):
                                                                                                                    $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales setup
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(9, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales setup
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(9, $admin_id, $limit, $statr = 5);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales report
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(12, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales report
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(12, $admin_id, $limit, $statr = 6);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <ul class="mega-menu-submenu">
                                                    ...
                                                    //account transaction
                                                    $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(14, $admin_id, $limit, $statr = 0);
                                                    foreach ($sub_menu as $each_menu):
                                                        $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //sales report
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(13, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //account report
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(15, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //opening
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(81, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    //sales report
                                                    $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(81, $admin_id, $limit, $statr = 6);
                                                    foreach ($sub_menu as $each_menu):
                                                        $url = $each_menu->url;
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //setup
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(2, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //setup
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(2, $admin_id, $limit, $statr = 5);
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="mega-menu-submenu">
                                                            ...
                                                            //setup
                                                            $sub_menu = $this->Common_model->get_data_list_by_main_menu_id(80, $admin_id, $limit, $statr = 0);
                                                            foreach ($sub_menu as $each_menu):
                                                                $url = $each_menu->url;
        ...
        $adminInfo = $this->db->get_where('admin', array('admin_id' => $admin_id))->row();
        ?>
        <div class="top-menu">
