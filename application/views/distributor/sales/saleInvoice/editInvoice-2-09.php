                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control date-picker" name="checkDate" name="purchasesDate" id="checkDate"
                               type="text" value="<?php echo $editInvoice->delivery_date!=''?date('d-m-Y', strtotime($editInvoice->delivery_date)):''; ?>" data-date-format="dd-mm-yyyy"/>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered table-hover tableAddItem" id="show_item">
                <thead>
                    <tr>
                        ...
                        <th nowrap><strong><?php echo  get_phrase('Unit Price')?>(<?php echo get_phrase('BDT')?>) <span style="color:red;"> *</span></strong></th>
                        <th nowrap><strong><?php echo  get_phrase('Total Price')?>(<?php echo get_phrase('BDT')?>) <span style="color:red;"> *</span></strong></th>
                                                ...
                                                <div class="col-md-2" style="margin-top: 10px;">
                                                    <div class="portlet box blue">
                                                        ...
                                                        <div class="portlet-body" style="padding:1px">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;" data-toggle="tooltip" title="Transportation (+) :"> <strong>Trans..(+) :</strong></label>
                                                                <div class="col-md-7">
                                                            ...
                                                            <div class="form-group creditDate" style="display:none;">
                                                                <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;"><strong><?php echo get_phrase('Due')?> <?php echo get_phrase('Date')?>
                                                                        :</strong></label>
                                                                <div class="col-md-7">
