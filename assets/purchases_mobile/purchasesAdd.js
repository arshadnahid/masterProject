...
function saveNewSupplier() {
    ...
    if (supplierId != '' && supName != '') {
        $.ajax({
            type: 'POST',
            url: baseUrl + "lpg/SupplierController/saveNewSupplier",
            ...
            if (quantity == '') {
                ...
                if (productCatID == 2) {
                    ...
                    tab = '<tr class="new_item' + j + '">' +
                        ...
                        '</td>' +
                        '<td align="right" >' +
                        '<input type="text" onclick="this.select();" class="add_ime_no  text-right form-control" id="ime_no' + j + '"  name="ime_no_' + slNo + '" value="' + ime_no + '" autocomplete="off">' +
                        //'<input type="hidden" class="text-right form-control" id="" readonly name="returnproduct_'+slNo+'[]" value="' + package_id2 + '">' +
                        '</td>' +
    ...
    $(document).on('click', '.AddreturnedProduct', function () {
        ...
        if (returnQuentity == '') {
            ...
            var tab2 = "<tr>" +
                ...
                "</td>" +
                "<td>" +
                '<div class="input-group"><input type="hidden" class="text-right form-control" id="" readonly name="returnQuentity_Price_' + id + '[]" value="' + returnedProductPrice + '"><input type="text" class="text-right form-control" id="" readonly name="returnQuentity_' + id + '[]" value="' + returnQuentity + '"><a href="javascript:void(0)" id="2" class="remove_returnable  input-group-addon"><i class="fa fa-minus-circle "></i> </a> </div>' +
