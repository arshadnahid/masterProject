...
/*                                        */?>
                                    ...
                                    <td class="text-right">
                                        <?php echo numberFromatfloat($queryAvarage_price->price) ?>
                                    </td>
                                    <td class="text-right">
                                        <?php
                                        $price = $queryAvarage_price->price * ($purchaseQty - $salesQty);
...
/*                                        */?>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo numberFromatfloat($ttPrice) ?></td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
