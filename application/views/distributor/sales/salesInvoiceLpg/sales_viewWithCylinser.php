            ...
            <ul class="breadcrumb pull-right">
                ...
                <li>
                    <a class="saleEditPermission"
                       href="<?php echo site_url('salesInvoice_edit/' . $saleslist->generals_id); ?>">
                        <i class="ace-icon 	fa fa-pencil bigger-130"></i> Edit
                    </a>
                </li>
                <li>
                    <a class="saleEditPermission"
                       href="<?php echo site_url('salesInvoice_view/' . $saleslist->generals_id); ?>">
                    ...
                    <div class="widget-box transparent">
                        <div class="widget-header widget-header-large">
                            ...
                            <div class="widget-toolbar no-border invoice-info">
                                ...
                                <span class="red"><?php echo $saleslist->voucher_no; ?>
                                    / <?php echo $saleslist->mainInvoiceId ?></span>
                                <br/>
                            ...
                            <div class="widget-main padding-24">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="col-xs-5">
                                                <ul class="list-unstyled  spaced">
                                                    <li>
                                                        <strong> Current Due: <span
                                                                    class="currentBalance"></span></strong>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div style="min-height:400px;">
                                    <table class="table table-striped table-responsive table-bordered">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <strong><span>In Words : &nbsp;</span> <?php echo $this->Common_model->get_bd_amount_in_text($saleslist->debit); ?>
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
...
<script>
    var url = "lpg/SalesController/getCustomerCurrentBalance2";
    $.ajax({
        type: 'POST',
        url: url,
        data: {
