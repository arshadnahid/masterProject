    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Payment Voucher Posting</li>
            </ul>

            <span style="padding-top: 5px!important;">
                <a style="border-radius:100px 0 100px 0;" href="<?php echo site_url('paymentVoucher'); ?>" class="btn btn-danger pull-right">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="publicForm" action="<?php echo site_url('paymentVoucherAdd/'.$paymentPosting->purchase_demo_id); ?>"  method="post" class="form-horizontal">
                        <div class="col-md-6">
...
if (!empty($paymentPosting->purchasesDate)) {
    echo $paymentPosting->purchasesDate;
} else {
    echo date('Y-m-d');
}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="voucherid" readonly value="<?php
                                               if (!empty($paymentPosting->voucherid)) {
                                                   echo $paymentPosting->voucherid;
                                               } else {
                                                   echo $voucherID;
                                               }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="payType" onchange="selectPayType(this.value)" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Search by payee">
                                        <option value=""></option>
                                        <option <?php
                                           if ($paymentPosting->payee == 1) {
                                               echo "selected";
                                           }
?> value="1">Miscellaneous</option>
                                        <option <?php
                                            if ($paymentPosting->payee == 2) {
                                                echo "selected";
                                            }
?> value="2">Customer</option>
                                        <option <?php
                                            if ($paymentPosting->payee == 3) {
                                                echo "selected";
                                            }
?> value="3">Supplier</option>
                                        ...
                                        foreach ($accountHeadList as $key => $head) {
                                            ...
                                            <optgroup label="<?php echo $head['parentName']; ?>">
                                                ...
                                                foreach ($head['Accountledger'] as $eachLedger) :
                                                    ?>
                                                    <option <?php
                                            if ($paymentPosting->accountCr == $eachLedger->chartId) {
                                                echo "selected";
                                            }
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <?php
                            $accountDr = explode(",", $paymentPosting->accountDr);
                            $accountDrPrice = explode(",", $paymentPosting->price);
                            $accountDrMemo = explode(",", $paymentPosting->memo);
                            ?>
                            ...
                            <table class="table table-bordered table-hover" id="show_item">
                                ...
                                <tbody>
                                    <?php foreach ($accountDr as $key => $value): ?>

                                        <tr class="new_item<?php echo $key + 1000; ?>">
                                            <td style="padding-left:15px;">
                                                <?php
                                                $account = $this->Common_model->tableRow('chartofaccount', 'chart_id', $value);
                                                echo $account->title . ' [ ' . $account->accountCode . ' ] ';
                                                ?>
                                                <input type="hidden" name="accountDr[]" value="<?php echo $value; ?>">
                                            </td>
                                            <td style="padding-left:15px;" align="right"><?php echo $accountDrPrice[$key]; ?><input class="amount amount3" type="hidden" name="amountDr[]" value="<?php echo $accountDrPrice[$key]; ?>"></td>
                                            <td align="right"><?php echo $accountDrMemo[$key]; ?><input type="hidden" class="add_quantity" name="memoDr[]" value="<?php echo $accountDrMemo[$key]; ?>"></td>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea cols="100" rows="2" name="narration" placeholder="Narration" type="text"><?php echo $paymentPosting->narration; ?></textarea>
    ...
    function checkOverAmount(amount){
     ...
     var url = '<?php echo site_url("FinaneController/getPayUserListPosting") ?>';
        $.ajax({
            type: 'POST',
            url: url,
            data:{'payid':'<?php echo $paymentPosting->payee;?>','payUserId':'<?php echo $paymentPosting->supplierID;?>'},
