...
$generalBusiness=0;
$hideLpgColumn='';
if($generalBusiness==1){
    $hideLpgColumn='display:none;';
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            <td class="text-right" style="width: 30%"><strong><?php echo get_phrase('Due') ?>:</strong>
                            </td>
            ...
            <table class="table table-bordered table-hover tableAddItem" id="show_item">
                ...
                <tr>
                    ...
                    <th nowrap><strong><?php echo get_phrase('Total Price') ?>(<?php echo get_phrase('BDT') ?>) <span
                                    style="color:red;"> *</span></strong></th>
                    <th nowrap style="width:17%;border-radius:10px;<?php echo $hideLpgColumn?>">
                        <strong><?php echo get_phrase('Returned Cylinder') ?> <span style="color:red;">
                    </th>
                    <th nowrap style="width:10%;border-radius:10px;<?php echo $hideLpgColumn?>">
                        <strong>
                ...
                <tr>
                    ...
                    <td style="<?php echo $hideLpgColumn?>">
...
<script>
    var hideLpgColumn;
    window.hideLpgColumn;
    $(document).ready(function () {
        hideLpgColumn='<?php echo $hideLpgColumn?>';
        alert(hideLpgColumn);
    });
    ...
    var calculateCustomerDue = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var i = 1;
                if (dueCylinder.advanceOrDue == null) {

                    $('#CylinderDueTable').hide();
                } else {
                    if (dueCylinder.advanceOrDue > 0) {
                        var text = 'Due &nbsp;:&nbsp;' + dueCylinder.advanceOrDue;
                    } else {
                        var text = 'Advance &nbsp;:&nbsp;' + (-1*dueCylinder.advanceOrDue);
                    }
                ...
                if (productCatID == 2) {
                    ...
                    if ($('.is_same').val() == 0) {
                        ...
                        tab = '<tr class="new_item' + j + '">' +
                            ...
                            '</td>' +
                            '<td colspan="3" style="'+hideLpgColumn +'">' +
                    ...
                    tab = '<tr class="new_item' + j + '">' +
                        ...
                        '<td align="right"><input readonly type="text" class="add_price text-right form-control" id="tprice_' + j + '" name="price[]" value="' + price + '">' +
                        '</td>' +
                        '<td colspan="2" style="'+hideLpgColumn +'">' +
                        '<table class="table table-bordered table-hover" style="margin-bottom: 0px;" id="return_product_' + slNo + '">' +
                        '<tr>' +
                        '<td>' +
                        '</td>' +
                    ...
                    success: function (data) {
                        ...
                        if (quantity <= MainQuantity) {
                            ...
                            tab = '<tr class="new_item' + productID + '">' +
                                ...
                                '</td>' +
                                '<td align="right">' +
                                '<input type="text" id="qty_' + productID + '" placeholder="'+MainQuantity+'" attr-pid="'+productID+'" class="form-control text-right add_quantity decimal" onkeyup="checkStockOverQty2(' + productID + ')" name="quantity_' + productID + '" value="' + quantity + '">' +
                                '</td>' +
...
<script type="text/javascript" src="<?php echo base_url('assets/sales_lpg/saleInvoice.js'); ?>"></script>
