<?php
//echo '<pre>';
//print_r($editPurchases);
//echo  $editPurchases->supplier_id;exit;
?>
...
<div class="row">
    <form id="publicForm" action="" method="post" class="form-horizontal">
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label text-right" style="white-space: nowrap; font-size:11px;"><strong><?php echo get_phrase('Previous Due')?>:</strong></label>
                <div class="col-md-7">
        ...
        <div class="col-md-12" id="showBankInfo" style="margin-top: 3px;<?php echo $style ?>">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="<?php echo $purchasesList->check_no; ?>" class="form-control" id="checkNo" name="checkNo"
        ...
        <div class="col-md-9" style="margin-top:10px">
            ...
            <table class="table table-bordered table-hover" id="show_item">
                ...
                <tr>
                    ...
                    <th nowrap style="width:23%;border-radius:10px;" id="product_th"><strong><?php echo get_phrase('Category')?><span style="color:red;"> *</span></strong></th>
                    <th nowrap style="width:30%" align="center" id="product_th"><strong><?php echo get_phrase('Product')?><span style="color:red;"> *</span></strong></th>
                    <th nowrap style="width:10%;white-space:nowrap; width:100px; vertical-align:top;"><strong><?php echo get_phrase('Quantity')?> <span  style="color:red;"> *</span></strong></th>
...
<!--                   <th nowrap style="width:17%;border-radius:10px;"><strong><?php /*echo get_phrase('Returned Cylinder');*/?> </strong><span style="color:red;"></span></th>-->
<!--                   <th nowrap style="width:10%;border-radius:10px;"><strong><?php /*echo  get_phrase('Returned Qty')*/?></strong> <span style="color:red;"></span></th>-->
...
<!--                    <td><input type="text"
                ...
                foreach ($stockListEdit[$purchasesList->purchase_invoice_id] as $key => $eachStock ){
                    ...
                    <tr class="new_item<?php echo $key + 10000; ?>">
                        ...
                        <td align="right">
                            <input type="text" id="qty_<?php echo $key + 10000; ?>" autocomplete="off" class="add_quantity text-right form-control decimal" name="quantity_<?php echo $eachStock['purchase_details_id']; ?>" value="<?php echo $eachStock['quantity']; ?>">
                        </td>
                        ...
                        <?php endif; ?>
                        <td align="right">
                            <input type="text" id="rate_<?php echo $key + 10000; ?>" autocomplete="off" class="add_rate  text-right form-control decimal" name="unit_price_<?php echo $eachStock['purchase_details_id']; ?>" value="<?php echo $eachStock['unit_price']; ?>">
                        </td>
                        <td align="right">
                            <?php
                            $totalEditPrice += ($eachStock['quantity']*$eachStock['unit_price']);
                            ?>
                            <input type="text" autocomplete="off" class="add_price form-control text-right" id="tprice_<?php echo $key + 10000; ?>" readonly name="price_[]" value="<?php echo ($eachStock['quantity']*$eachStock['unit_price']); ?>">
                        </td>
                        ...
                        <td>
                            <a del_id="<?php echo $key + 10000; ?>" autocomplete="off" class="delete_item btn form-control btn-danger" href="javascript:void(0);" title=""><i class="fa fa-times"></i>&nbsp;</a>
                        </td>
                    </tr>
        ...
        <div class="col-md-3" style="margin-top: 10px;">
            <div class="portlet box blue">
                ...
                <div class="portlet-body" style="padding:1px">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px"><strong><?php echo get_phrase('Net Total')?> :</strong></label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group" id="paymentDiv">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;"><strong><?php echo get_phrase('Payment')?>( - ):</strong></label>
                        <div class="col-md-7">
                            <input name="thisAllotment"
                                   id="thisAllotment" type="text"
                                   onkeyup="calcutateFinal(this.value)"
                                   class="form-control text-right payment" value="<?php echo $purchasesList->paid_amount?>"
                    ...
                    <div class="form-group creditDate" style="display:none;">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;"><strong><?php echo get_phrase('Due Amount')?>:</strong></label>
                        <div class="col-md-7">
                            <input type="text" readonly
                                   class="form-control text-right"
                                   value="" id="currentDue"
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;"><strong><?php echo get_phrase('Total Due')?>:</strong></label>
                        <div class="col-md-7">
                            <input type="text" readonly
                                   class="form-control text-right"
                                   value="" id="totalDue"
...
<script>
    ...
    $(document).ready(function () {
       var cusId=$('#supplierid').val();
        getSupplierClosingBalance(cusId);
                        ...
                        if (quantity > 0) {
                            ...
                            var tab = "";
                                tab = '<tr class="new_item' + slNo + '">' +
                                    ...
                                    '<input type="hidden" name="Addbrand_id[]" value="' + '' + '"/>' +
                                    ...
                                    '</td>' +
                                    '<td align="right" style="display: none">' +
                                    '<input type="text" class="add_return form-control text-right decimal "  id="qtyReturn_' + slNo + '"   name="add_returnAble[' + slNo + ']" value="' + '' + '"  >' +
                                    '</td>' +
                                    '<td align="right">' +
                                    '<input type="text" id="rate_' + slNo + '" class="add_rate form-control decimal text-right" name="Addrate_' + slNo + '" value="' + rate + '" placeholder="'+rate+'">' +
                                    '</td>' +
                                    '<td align="right" style="">' +
                                    '<input type="text" class="add_price  text-right form-control" id="tprice_' + slNo + '" readonly name="Addprice[]" value="' + '' + '">' +
                                    '</td>' +
                                    '<td style="display: none" colspan="2">' +
                                    '</td>' +
                                    '<td>' +
