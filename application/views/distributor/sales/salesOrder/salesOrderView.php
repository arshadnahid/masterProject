...
<!--                            <div class="widget-toolbar no-border invoice-info">
                            ...
                            <div class="widget-toolbar no-border invoice-info">
                                ...
                                <span class="blue"><?php 
                                if($saleslist->orderStatus == 1){
                                    echo "Pending";
                                }elseif($saleslist->orderStatus == 2){
                                    echo "Confirm";
                                }else{
                                    echo "Cancel";
                                }?></span>
                                ...
                                <span class="red"><a href="<?php echo site_url('salesOrderConfirm/' . $saleslist->generals_id); ?>"> <span class="label label-xlg label-info arrowed arrowed-right"><i class="fa fa-refresh fa-spin fa-fw"></i>&nbsp;Confirm ? </span>
                                            </a></span>
                            ...
                            <div class="widget-toolbar no-border invoice-info">
                                ...
                                <br />
                                <span class="invoice-info-label">Delivery Date:</span>
                                <span class="blue"><?php echo $saleslist->deliveryDate ?></span>
                            </div>
                            <div class="widget-toolbar no-border invoice-info">
                                <span class="invoice-info-label">Reference By:</span>
                                <span class="red"><?php echo $this->Common_model->tableRow('reference','reference_id',$saleslist->reference)->referenceName; ?></span>
