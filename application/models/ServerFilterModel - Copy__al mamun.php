...
private function _get_productBrand_datatables_query() {
  ...
  private function _get_customer_due_datatables_query() {
    ...
    private function _get_payment_datatables_query() {
        ...
        accounts_vouchertype_autoid.Accounts_VoucherType,sum(ac_tb_accounts_voucherdtl.GR_DEBIT) as amount ,
        ac_accounts_vouchermst.Accounts_VoucherMst_AutoID,ac_accounts_vouchermst.Accounts_Voucher_Date,
        ac_accounts_vouchermst.Accounts_Voucher_No,ac_accounts_vouchermst.Narration,
 ...
 private function _get_journal_datatables_query()
    {
        ...
        $this->db->select("accounts_vouchertype_autoid.Accounts_VoucherType,ac_accounts_vouchermst.Accounts_VoucherMst_AutoID,ac_accounts_vouchermst.Accounts_Voucher_No,ac_accounts_vouchermst.Narration,ac_accounts_vouchermst.Accounts_Voucher_Date,sum(ac_tb_accounts_voucherdtl.GR_CREDIT) as total_amount");
        $this->db->from("ac_accounts_vouchermst");
