                    ...
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                $productCost = 0;
                                $totalIncome = 0;
                                $sales_revenue = $this->Accounts_model->get_sales_revenue($start_date, $end_date, $branch=1);

                                $cost_of_goods = $this->Accounts_model->get_cost_of_goods_group_sum($start_date, $end_date, $branch=1);
                                    ...
                                    foreach ($value_sales_revenue as $key => $value) {
                                        ...
                                        <tr class="sales-revenue-ledger">
                                            ...
                                            <td align="right">
                                                ...
                                                if ($sales < 0) {
                                                    echo '( ' . (numberFromatfloat((-1 * $sales))) . ' )';
                                                } else {
                                                    echo numberFromatfloat($sales);
                                                }
                                ...
                                <tr class="cost-of-goods-sold">
                                    ...
                                    <td class="cost-of-goods-sold-td text-right" colspan="2">
                                        ...
                                        if ($sales < 0) {
                                            echo '( ' . (numberFromatfloat((-1 * $cost_of_goods_amount))) . ' )';
                                        } else {
                                            echo numberFromatfloat($cost_of_goods_amount);
                                        }
                                ...
                                <?php
                                $other_income = $this->Accounts_model->get_other_income_without_sales_revenue($start_date, $end_date, $branch=1);
                                            ...
                                            foreach ($value as $key => $value2) { ?>
                                                <tr class="sales-revenue-ledger">
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        echo $other_income = (-1 * ($value2->Balance));
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <?php echo numberFromatfloat($totalExpance) ?>
                                    </td>
                                </tr>
