        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"><?php echo get_phrase(' Purchases_Invoice')?></span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                        <label><?php echo get_phrase('Purchases_Voucher')?> : <span style="color:red; padding-right:5px"><?php echo $purchasesList->invoice_no; ?></span></label>
                        <label><span><?php echo get_phrase(' Payment_Type')?> :</span>
                                <span style="color:red;padding-right:5px"><?php
                                    ...
                                    ?></span></label>
                        <label><span><?php echo get_phrase(' Date')?> :</span><span class="red"><?php echo date('d-m-Y', strtotime($purchasesList->invoice_date)); ?></span></label>
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                ...
                                                <li>
                                                   <?php echo get_phrase('Company_Name')?> : <?php echo $companyInfo->companyName; ?>
                                                </li>
                                                <li>
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <li>
                                                   <?php echo get_phrase('Name')?> : <?php echo $supplierInfo->supID . '[' . $supplierInfo->supName . ']' ?>
                                                </li>
                                                <li>
                                                   <?php echo get_phrase('Email')?> : <?php echo $supplierInfo->supEmail; ?>
                                                </li>
                                                <li>
                                                    <?php echo get_phrase('Phone')?> : <?php echo $supplierInfo->supPhone; ?>
                                                </li>
                                                <li>
                                                   <?php echo get_phrase('Address')?> : <?php echo $supplierInfo->supAddress; ?>
                                                </li>
                                            </ul>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-striped" id="ALLPRODUCT">
                                        ...
                                        <tr>
                                           ...
                                           <!-- <td><strong><?php /*echo get_phrase('Return_Product')*/?></strong></td>
                                            <td><strong><?php /*echo get_phrase('Quantity_Return')*/?></strong></td>-->
                                            <td class="text-right"><strong><?php echo get_phrase('Quantity')?></strong></td>
                                            <td class="text-right"><strong><?php echo get_phrase('Unit_Price')?></strong></td>
                                            <td class="text-right"><strong><?php echo get_phrase('Total_Price')?></strong></td>
                                        ...
                                        <tfoot>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Sub_Total')?></strong></td>
                                            <td align='right'><?php echo number_format((float)$tprice, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Discount')?> ( - )</strong></td>
                                            <td align='right'><?php echo number_format((float)$purchasesList->discount_amount, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Loader')?> ( + )</strong></td>
                                            <td align='right'><?php echo number_format((float)$purchasesList->loader_charge, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Transportation')?> ( + )</strong></td>
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Net_Total')?></strong></td>
                                            <td align='right'><?php echo number_format((float)$netAmount, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Payment')?></strong></td>
                                            <td align='right'><?php echo number_format((float)$purchasesList->paid_amount, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right"><strong><?php echo get_phrase('Due_Amount')?></strong></td>
