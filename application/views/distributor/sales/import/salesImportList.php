    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Sales Import List</li>
            </ul>
            
            <ul class="breadcrumb pull-right">
                <li>
                    <a class="saleAddPermission" href="<?php echo site_url('addSalesImport'); ?>">
            ...
            <div class="row">
                ...
                <div>
                    <table id="example" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            foreach ($salesImportList as $key => $value):
                                //  dumpVar($value);
                                ...
                                ?></td>
                                    ...
                                    <td nowrap>
                                        <?php if ($value->ConfirmStatus == 0): ?>
                                            <a href="<?php echo site_url('salesImportConfirm/' . $value->purchase_demo_id); ?>"> <span class="label label-xlg label-danger arrowed arrowed-right"><i class="fa fa-refresh fa-spin fa-fw"></i>&nbsp;Pendig </span></a>
                                        <?php else: ?>
