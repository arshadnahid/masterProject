    ...
    <form id="publicForm" action="" method="post" class="form-horizontal">
                ...
                <div class="col-sm-7">
                    <select style="width:100%!important;" name="accountCrPartial"
                        ...
                        foreach ($accountHeadList as $key => $head) {
                            if ($key != 51 || $key != 112) {
                                ?>
                                <optgroup label="<?php echo get_phrase($head['parentName']); ?>">
                                    <?php
        ...
        <div class="col-md-2" style="margin-top: 10px;">
            ...
            <table class="table table-fixed " id="CylinderDueTable">
                <thead>
                <tr>
                    <th class="col-md-2" style="margin-left: -8px;"><strong><?php echo get_phrase('Si') ?></strong></th>
        ...
        <div class="col-md-12" id="showBankInfo" style="display:none;margin-top: -55px;">
            ...
            <div class="col-md-4">
                <div class="form-group" style="margin-left: -29px;">
                    <label class="col-sm-3 control-label formfonterp" for="form-field-1">
                        <strong><?php echo get_phrase('Bank_Name') ?></strong></label>
                    <div class="col-sm-7">
                ...
                <div class="portlet-body" style="padding:1px">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label" style="white-space: nowrap; font-size:11px;"
                               data-toggle="tooltip" title="Transportation (+) :">
