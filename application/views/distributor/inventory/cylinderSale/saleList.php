    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <span style="padding-top: 5px!important;">
                <a style="border-radius:100px 0 100px 0;" href="<?php echo site_url('cylinderExchangeAdd'); ?>" class="btn btn-success pull-right">
            ...
            <div class="row">
                ...
                <div>
                    <table id="example" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            foreach ($cylinderExchangeList as $key => $value):
                                ?>
                                <tr>
                                ...
                                ?></td>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="blue" href="<?php echo site_url('viewCylinderExchange/' . $value->generals_id); ?>">
