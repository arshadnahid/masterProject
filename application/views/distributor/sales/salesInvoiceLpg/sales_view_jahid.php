...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title" style="padding: 4px 21px 0px;">
                <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12" style="margin-top: -15px;">
                                <div class="portlet green-meadow box" style="border: 1px solid #3598dc;">
                                    <div class="portlet-title noPrint" style="background-color: #3598dc;">
                                        <div class="caption">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <h3 style="font-size:17px;font-weight:600;margin-top: 2px;margin-bottom: 2px;"><?php echo get_phrase('Company Info') ?></h3>
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <strong> <?php echo get_phrase('Branch') ?></strong>
                                            ...
                                            <div class="col-xs-3">
                                                <h3 style="font-size:17px;font-weight:600;margin-top: 2px;margin-bottom: 2px;"><?php echo get_phrase('Customer_Info') ?></h3>
                                                <ul class="list-unstyled ">
                                                    <li>
                                                        <strong><?php echo get_phrase('Name') ?>
                                                            :</strong> <?php echo $customerInfo->customerName;//. '[' . $customerInfo->customerID . ']' ?>
                                                    </li>
                                                    <?php
                                                    if (!empty($customerInfo->customerEmail)) {
                                                        ?>
                                                        <li>
                                                            <strong><?php echo get_phrase('Email') ?>: </strong><?php
                                                            if (!empty($customerInfo->customerEmail)) {
                                                    ...
                                                    ?>
                                                    <li>
                                                        <strong><?php echo get_phrase('Phone') ?>:</strong> <?php
                                                        if (!empty($customerInfo->customerPhone)) {
                                                    ...
                                                    ?>
                                                    <li>
                                                        <strong><?php echo get_phrase('Address') ?>:</strong> <?php
                                                        if (!empty($customerInfo->customerAddress)) {
                                            ...
                                            <div class="col-xs-3 invoice-payment">
                                                <h3 style="font-size:17px;font-weight:600;margin-top: 2px;margin-bottom: 2px;"><?php echo get_phrase('Invoice Info') ?></h3>
                                                <ul class="list-unstyled">
                                                    <li>
                                                        <?php
                                                        if ($customerDue->totalbalance < 0) {
                                                            ?>
                                                            <strong><?php echo get_phrase('Advance') ?>:</strong> <span
                                                        ...
                                                        <?php } else { ?>
                                                            <strong> <?php echo get_phrase('Current Due') ?>: </strong>
                                                            <span
                                                                    class="currentBalance">
                                                            <?php
                                                    ...
                                                    <li>
                                                        <strong> <?php echo get_phrase('Transportation') ?>
                                                            :</strong> <?php
                                                    ...
                                                    <li>
                                                        <strong><?php echo get_phrase('Loader') ?>:</strong>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong><?php echo get_phrase('Product') . ' ' . get_phrase('Category') ?></strong>
                                            </td>
                                            <td><strong><?php echo get_phrase('Product') ?></strong></td>
                                            <td><strong><?php echo get_phrase('Recive Product') ?></strong></td>
                                            <td><strong><?php echo get_phrase('Quantity Recived') ?></strong></td>
                                            <td style="text-align: right">
                                                <strong><?php echo get_phrase('Quantity') ?></strong></td>
                                            <td style="text-align: right">
                                                <strong><?php echo get_phrase('Unit Price') ?> </strong></td>
                                            <td style="text-align: right">
                                                <strong><?php echo get_phrase('Total Price') ?></strong></td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        foreach ($stockList[$saleslist->sales_invoice_id] as $key => $each_info):
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1">
                                                    <table style="border: 1px solid #e7ecf1;width: 100%;">
                                                        <?php
                                                        foreach ($each_info['return'] as $key1 => $value1) {
                                                            foreach ($value1 as $key2 => $value2) {
                                                                ?>
                                                                <tr>
                                                                    <td style="border: 1px solid #e7ecf1"><?php echo $value2['return_product_cat'] . ' ' . $value2['return_product_name'] . ' ' . $value2['return_product_unit'] . '[ ' . $value2['return_product_brand'] . ' ]' ?></td>
                                                    ...
                                                    <table style="border: 1px solid #e7ecf1;width: 100%;">
                                                        ...
                                                        foreach ($each_info['return'] as $key1 => $value1) {
                                                            foreach ($value1 as $key2 => $value2) {
                                                                ?>
                                                                <tr>
                                                                    <td style="border: 1px solid #e7ecf1"><?php echo $value2['returnable_quantity'] ?></td>
                                                                </tr>
