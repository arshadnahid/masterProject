            ...
            if (quantity == '') {
                ...
                if (productCatID == 2) {
                    ...
                    tab = '<tr class="new_item' + slNo + '">' +
                        ...
                        '<input type="text" class="add_quantity decimal form-control text-right" id="qty_' + slNo + '" name="Addquantity_' + slNo + '" value="' + quantity + '">' +
                        '</td>' +
                        '<td align="right"><input type="text" class="add_return form-control text-right decimal "  id="qtyReturn_' + slNo + '"   name="add_returnAble[' + slNo + ']" value=""  readonly>' +
                        '</td>' +
                        '<td align="right">' +
                        '<input type="text" id="rate_' + slNo + '" class="add_rate form-control decimal text-right" name="Addrate_' + slNo + '" value="' + rate + '">' +
                        '</td>' +
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, value) {
                        ...
                        $("#show_item tfoot").append('<tr class="new_item' + slNo + ' packageDeleteRow_' + value['package_id'] + '"   ><input type="hidden" name="slNo[' + slNo + ']" value="' + slNo + '"/><input type="hidden" name="Addis_package_' + slNo + '" value="1"><input type="hidden" name="Addcategory_id_' + slNo + '" value="' + value['category_id'] + '">' +
                            ...
                            '</td><td align="right"><input type="text" class="add_quantity decimal form-control text-right" id="qty_' + slNo + '" name="Addquantity_' + slNo + '" value="' + quantity + '"></td><td align="right"><input type="text" class="add_return form-control text-right decimal "  id="qtyReturn_' + slNo + '"   name="add_returnAble[]" value=""  readonly></td><td align="right"><input type="text" id="rate_' + slNo + '" class="add_rate form-control decimal text-right" name="Addrate_' + slNo + '" value="' + rate + '"></td><td align="right"><input type="text" class="add_price  text-right form-control" id="tprice_' + slNo + '" readonly name="Addprice[]" value="' + price + '"></td><td></td><td></td><td style="' + style + '"   rowspan="' + rowspan + '" ><a del_id="' + slNo + '" package_id_delete="' + value['package_id'] + '" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;</a></td></tr>');
                        j++;
                        style = 'display:none';
