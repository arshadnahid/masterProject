                                    ...
                                    foreach ($value as $key2 => $value2) { ?>
                                        ...
                                        foreach ($value2 as $key3 => $value3) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo numberFromatfloat($value3->OP_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($value3->OP_UPrice*$value3->OP_quantity_refill); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($value3->Pur_quantity_refill); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($value3->Pur_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($value3->Pur_quantity_refill*$value3->Pur_UPrice); ?></td>
                                                ...
                                                <td class="text-right"><?php echo numberFromatfloat($value3->S_quantity_refill*$value3->Sales_Amount); ?></td>
                                                ...
                                                <td class="text-right">
                                                    <?php
                                                    $ttClogingEmptyValue+=($value3->C_quantity_refill*$value3->Closing_UPrice);
                                                    echo numberFromatfloat(($value3->C_quantity_refill*$value3->Closing_UPrice));
                                                    ?>
                                                </td>
                                ...
                                foreach ($stockEmptyCylinder as $key => $value) {
                                    ...
                                    foreach ($value as $key2 => $value2) { ?>
                                        ...
                                        foreach ($value2 as $key3 => $value3) {
                                            ...
                                            $OP_UPrice=$qtyOP>0?$value3->OP_UPrice:0;
                                            $Pur_UPrice=$qtyPur>0?$value3->Pur_UPrice:0;
                                            $Sales_UPrice=$qtySales>0?$value3->Sales_UPrice:0;
                                            //$Closing_UPrice=$qtyClosing>0?$value3->Closing_UPrice:0;
                                            $Closing_UPrice=$value3->Closing_UPrice;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo numberFromatfloat($OP_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($OP_UPrice*$qtyOP); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($qtyPur); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($Pur_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($qtyPur*$Pur_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($qtySales); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($Sales_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($qtySales*$Sales_UPrice); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($qtyClosing); ?></td>
                                                <td class="text-right"><?php echo numberFromatfloat($Closing_UPrice); ?></td>
                                                <td class="text-right">
                                                    <?php
                                                    $ttClogingEmptyValue+=($qtyClosing*$Closing_UPrice);
                                                    echo numberFromatfloat(($qtyClosing*$Closing_UPrice));
                                                    ?>
                                                </td>
